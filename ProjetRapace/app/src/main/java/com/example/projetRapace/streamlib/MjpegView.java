...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static ByteArrayInputStream mRecordOutput;
    private static MutableBoolean mIsRecording;
    private MjpegRecorder recorder;
    private Bitmap bm;
...
//                                    recorder.addFrameToRecord(bm);
    ...
    private void init(Context context) {
        mIsRecording = new MutableBoolean(false);
        mRecordOutput = null;
        recorder = new MjpegRecorder(this);
    ...
    public void startPlayback() {
        boolean bool = mIn!=null;
        Log.d("CREATION", String.valueOf(bool));
        if(mIn != null) {
            mRun = true;

            Log.d("CREATION", "PLAYBACK");
            thread.start();
        }
    }
    ...
    //Gestion du record Video/Image
    public void startRecord(String filename) {
        if(!mIsRecording.value) {
            Log.d("CREATION", "RECORD START");
            mIsRecording.value = recorder.startRecord(filename);
        }
    }
