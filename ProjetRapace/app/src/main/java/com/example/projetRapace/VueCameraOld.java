...
public class VueCameraOld extends BaseActivity {
...
//                        ((EditText) findViewById(R.id.IpCamera)).setText(c.getIp());
//
//                        Picasso.get().load(c.getIp()).centerCrop().fit().into((ImageView) findViewById(R.id.previewDirect));
//
//                        ((ImageButton) findViewById(R.id.boutonEdit)).setVisibility(View.VISIBLE);
//                        ((ImageButton) findViewById(R.id.boutonSave)).setVisibility(View.GONE);
//                        ((ImageButton) findViewById(R.id.boutonCancel)).setVisibility(View.GONE);
//
//                        ((ImageButton) findViewById(R.id.boutonEdit)).setOnClickListener(
//                                new View.OnClickListener() {
//                                    @Override
//                                    public void onClick(View v) {
//                                        ((EditText) findViewById(R.id.NomCamera)).setBackgroundResource(android.R.drawable.edit_text);
//                                        ((EditText) findViewById(R.id.NomCamera)).setInputType(InputType.TYPE_TEXT_VARIATION_PERSON_NAME);
//
//                                        ((EditText) findViewById(R.id.IpCamera)).setBackgroundResource(android.R.drawable.edit_text);
//                                        ((EditText) findViewById(R.id.IpCamera)).setInputType(InputType.TYPE_TEXT_VARIATION_POSTAL_ADDRESS);
//
//                                        ((ImageButton) findViewById(R.id.boutonEdit)).setVisibility(View.GONE);
//                                        ((ImageButton) findViewById(R.id.boutonSave)).setVisibility(View.VISIBLE);
//                                        ((ImageButton) findViewById(R.id.boutonCancel)).setVisibility(View.VISIBLE);
//                                    }
//                                }
//                        );
//
//                        ((ImageButton) findViewById(R.id.boutonCancel)).setOnClickListener(
//                                new View.OnClickListener() {
//                                    @Override
//                                    public void onClick(View v) {
//                                        ((EditText) findViewById(R.id.NomCamera)).setBackgroundResource(0);
//                                        ((EditText) findViewById(R.id.NomCamera)).setInputType(InputType.TYPE_NULL);
//
//                                        ((EditText) findViewById(R.id.IpCamera)).setBackgroundResource(0);
//                                        ((EditText) findViewById(R.id.IpCamera)).setInputType(InputType.TYPE_NULL);
//
//                                        ((ImageButton) findViewById(R.id.boutonEdit)).setVisibility(View.VISIBLE);
//                                        ((ImageButton) findViewById(R.id.boutonSave)).setVisibility(View.GONE);
//                                        ((ImageButton) findViewById(R.id.boutonCancel)).setVisibility(View.GONE);
...
//                        );
//
//                        ((ImageButton) findViewById(R.id.boutonSave)).setOnClickListener(
//                                new View.OnClickListener() {
//                                    @Override
//                                    public void onClick(View v) {
//                                        CameraLoading = false;
...
//                                                    try {
//                                                        Log.d("VueCamera", "(retour CAMERA_DB_UPDATE) -> "+ output);
//                                                        JSONObject jsonResult = new JSONObject(output);
//                                                        c = Camera.cameraFromJSON(jsonResult);
...
//                                            }
//                                        };
//                                        CameraDBManager.updateCamera(callbackCamera,c);
//
